...
info = {
 'name' : "BL652 Module",
 'link' :  [ "https://www.lairdconnect.com/wireless-modules/bluetooth-modules/bluetooth-5-modules/bl652-series-bluetooth-v5-nfc" ],
 'espruino_page_link' : 'BL652', 
 ...
 'bootloader' : 1,
 'binary_name' : 'espruino_%v_bl652.hex',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'BLUETOOTH',
   ...
   'makefile' : [
     ...
     'DEFINES+=-DBLUETOOTH_NAME_PREFIX=\'"BL652"\'',
...
#board {
  ...
  top: 0px;
  left : 200px;
  background-image: url(img/BL652.jpg);
}
#boardcontainer {
  height: 650px;
}
